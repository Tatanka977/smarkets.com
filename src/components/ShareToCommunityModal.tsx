...
const labelStyle: any = { fontSize: 11, color: B.gray3, letterSpacing: "0.08em", fontFamily: FONT, marginBottom: 4 };
  ...
  return (
    ...
    >
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        {error && <div style={{ fontSize: 12, color: B.red, fontFamily: FONT }}>{error}</div>}

        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 4 }}>
          <button onClick={onClose} style={{ background: "none", border: "none", color: B.gray3, cursor: "pointer", fontFamily: FONT, fontSize: 13, fontWeight: 700 }}>
            CANCEL
          </button>
          <button
            ...
            style={{
              ...
              border: "none", padding: "8px 18px", borderRadius: 6, fontFamily: FONT, fontSize: 13, fontWeight: 700,
